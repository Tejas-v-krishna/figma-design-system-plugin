...
export const COMPONENT_DEFINITIONS: ComponentDefinition[] = [
  ...
  // INPUTS
  {
    ...
    variants: [
      ...
      { name: 'URL', properties: { variant: 'url' } },
      { name: 'Tel', properties: { variant: 'tel' } },
      { name: 'WithIcon', properties: { variant: 'withicon' } },
      { name: 'FloatingLabel', properties: { variant: 'floatinglabel' } },
    ],
    states: [
      { name: 'Default', properties: { state: 'default' } },
      { name: 'Hover', properties: { state: 'hover' } },
    ...
    sizes: [
      { name: 'sm', properties: { name: 'sm', height: 32, fontSize: 12 } },
      { name: 'md', properties: { name: 'md', height: 40, fontSize: 14 } },
      { name: 'lg', properties: { name: 'lg', height: 48, fontSize: 16 } },
    ],
